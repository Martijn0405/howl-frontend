...
import CardCsgo from "assets/img/card_csgo.png"
import CardDota from "assets/img/card_dota.png"
import CardGpay from "assets/img/card_gpay.png"
import CardPaypal from "assets/img/card_paypal.png"
import CardPaysafe from "assets/img/card_paysafe.png"
import CardRust from "assets/img/card_rust.png"
import CardVisa from "assets/img/card_visa.png"
...
const ModalWallet = ({ open, handler }: { open: boolean; handler: any }) => {
  ...
  return (
    <>
      <Wrapper open={open}>
        <Modal open={open} up={walletUp} full>
          <ModalBg handler={handler} full />
                    ...
                    <div className="grid w-full grid-cols-2 gap-[12px] sm:grid-cols-3">
                      ...
                      >
                        <div className="relative flex h-[64px] w-full items-center justify-center lg:h-[84px]">
                          ...
                          />
                          <ShapeYellow className="absolute top-[50%] left-[50%] max-w-[120px] translate-x-[-50%] translate-y-[-50%] transform" />
                          <Btc className="tr-a relative h-[56px] w-[56px] transform group-hover:rotate-[-15deg] group-hover:scale-[1.1]" />
                        </div>
                      ...
                      >
                        <div className="relative flex h-[64px] w-full items-center justify-center lg:h-[84px]">
                          ...
                          <Eth className="tr-a relative h-[56px] w-[56px] transform group-hover:rotate-[-15deg] group-hover:scale-[1.1]" />
                        </div>
                        <ModalWalletBoxCrypto
                          crypto={
                            <>
                      ...
                      >
                        <div className="relative flex h-[64px] w-full items-center justify-center lg:h-[84px]">
                          ...
                          <Ltc className="tr-a relative h-[56px] w-[56px] transform group-hover:rotate-[-15deg] group-hover:scale-[1.1]" />
                        </div>
                        <ModalWalletBoxCrypto
                          crypto={
                            <>
