      ...
      >
        {message.reply ? (
          <div className="relative flex h-24 w-full items-center pl-14">
            <div className="absolute top-12 -left-34 h-50 w-16 rounded-l-4 border-l-2 border-t-2 border-b-2 border-grey-med-4"></div>
            <div
              className={`absolute top-[50%] -left-20 h-32 w-32 translate-y-[-50%] transform rounded-full border-4 ${
                replyToMe ? "border-grey-dark" : "border-grey-med"
              }`}
            >
              <img alt="" className="h-full w-24 rounded-full" src={message.reply.avatar} />
            </div>
            <div className="w-full truncate overflow-ellipsis text-11 text-grey-light-3">
              <span className="text-11 font-semibold text-grey-med-7">{message.reply.name}:</span>{" "}
        ...
        <div className="relative w-full">
          <div className="relative grid w-full grid-cols-1 gap-6 overflow-hidden rounded-4 bg-grey-med-2 py-10 pl-32 pr-24">
              ...
              {
                {
                  [""]: <></>,
                  ["vip"]: (
                    <div className="absolute left-0 top-0 h-full w-full rounded-l-4 rounded-r-6 border-1 border-vip"></div>
                  ),
                  ["mod"]: (
                    <div className="absolute left-0 top-0 h-full w-full rounded-l-4 rounded-r-6 border-1 border-mod"></div>
                  ),
                  ["admin"]: (
                    <div className="absolute left-0 top-0 h-full w-full rounded-l-4 rounded-r-6 border-1 border-admin"></div>
                  ),
                  ["streamer"]: (
                    <div className="absolute left-0 top-0 h-full w-full rounded-l-4 rounded-r-6 border-1 border-streamer"></div>
                  )
                }[message.type]
              }
              ...
              {
                {
                  [""]: <></>,
                  ["vip"]: (
                    <div className="from-vip-10 absolute left-0 top-0 h-full w-full rounded-l-4 bg-gradient-to-r to-transparent"></div>
                  ),
                  ["mod"]: (
                    <div className="from-mod-10 absolute left-0 top-0 h-full w-full rounded-l-4 bg-gradient-to-r to-transparent"></div>
                  ),
                  ["admin"]: (
                    <div className="from-admin-10 absolute left-0 top-0 h-full w-full rounded-l-4 bg-gradient-to-r to-transparent"></div>
                  ),
                  ["streamer"]: (
                    <div className="from-streamer-10 absolute left-0 top-0 h-full w-full rounded-l-4 bg-gradient-to-r to-transparent"></div>
                  )
                }[message.type]
              }
            </div>
            <div className="relative grid w-full grid-cols-[auto,1fr] gap-8">
              {
                {
                  [""]: (
                    <div className="relative flex h-20 min-w-20 items-center justify-center overflow-hidden rounded-4 bg-grey-dark px-4 shadow-level">
                  ...
                  ["mod"]: (
                    <div className="relative flex h-20 min-w-20 items-center justify-center overflow-hidden rounded-4 bg-grey-dark px-4 shadow-mod">
                  ...
                  ["admin"]: (
                    <div className="relative flex h-20 min-w-20 items-center justify-center overflow-hidden rounded-4 bg-grey-dark px-4 shadow-admin">
                  ...
                  ["streamer"]: (
                    <div className="relative flex h-20 min-w-20 items-center justify-center overflow-hidden rounded-4 bg-grey-dark px-4 shadow-streamer">
                  ...
                  ["vip"]: (
                    <div className="relative flex h-20 min-w-20 items-center justify-center overflow-hidden rounded-4 bg-grey-dark px-4 shadow-vip">
            ...
            <div className="absolute top-0 right-0 rounded-bl-4 bg-white-2 px-6 py-2 text-11 font-semibold text-grey-light-5">
              {moment(message.date).format(DATE.TIME)}
            </div>
          </div>
          <div
            ref={avatar}
            className="absolute top-4 -left-25 flex h-50 w-50 items-center justify-center rounded-full bg-grey-med"
          >
