  ...
  return (
    <>
      <div className="flex items-center">
        <div className="relative flex h-42 overflow-hidden rounded-l-4 bg-grey-med-4 py-1 pl-1">
          ...
          <div className="relative flex items-center rounded-l-4 bg-grey-dark-2">
            ...
            <div className="relative flex items-center gap-16 px-12">
              <div className="flex items-center gap-10">
                <Coin className="h-24" />
                <div className="text-14 font-bold text-white">256,000</div>
              </div>
